...
export default function AdminPanel() {
  ...
  const [activeTab, setActiveTab] = useState<"instagram" | "contacts">("instagram");
  ...
  const fetchContactSubmissions = async () => {
    try {
      ...
      alert(`İletişim formları yüklenirken hata: ${error?.message || "Bilinmeyen hata"}`);
  ...
  const handleAddPost = async () => {
    try {
      ...
      if (!imageUrl) {
        alert("Lütfen bir görsel URL'i girin veya dosya yükleyin.");
        setUploading(false);
        return;
      }
  ...
  const handleDeleteSubmission = async (id: string) => {
    ...
    try {
      ...
      alert(`Silme hatası: ${errorMessage}\n\nNot: Supabase'de DELETE policy'sinin eklendiğinden emin olun.`);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-50 to-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: "#60091b" }}>
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <div>
                <h1 className="text-2xl font-bold" style={{ color: "#60091b" }}>
                  Admin Paneli
                </h1>
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Tabs */}
        <div className="bg-white rounded-xl shadow-md p-1 mb-6 inline-flex gap-2">
          <button
            ...
            style={activeTab === "instagram" ? { backgroundColor: "#F07D2C" } : {}}
          >
          ...
          <button
            ...
            className={`px-6 py-3 font-semibold rounded-lg transition-all duration-200 flex items-center gap-2 relative ${
              activeTab === "contacts"
                ? "text-white shadow-lg transform scale-105"
                : "text-gray-600 hover:text-gray-900 hover:bg-gray-50"
            }`}
            style={activeTab === "contacts" ? { backgroundColor: "#3699BF" } : {}}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            İletişim Formları
            {unreadCount > 0 && (
              <span className="ml-2 px-2 py-0.5 text-xs font-bold text-white rounded-full" style={{ backgroundColor: "#F07D2C" }}>
                {unreadCount}
              </span>
            )}
          </button>

...
export default function ContactHero() {
  return (
    <section className="relative w-full min-h-[350px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[600px] flex items-center overflow-hidden mt-20 md:mt-24">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:pt-24 md:pb-16">
        <div className="max-w-3xl">
          ...
          >
            Ücretsiz danışmanlık alın, size en uygun eğitim programını bulalım.
          </motion.p>

...
export default function LanguageSchoolCTA() {
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-5 py-2 sm:px-6 sm:py-2.5 md:px-8 md:py-3 rounded-lg font-semibold text-white text-sm sm:text-base md:text-lg transition-all hover:opacity-90"
                  style={{ backgroundColor: '#F07D2C' }}
                >
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-5 py-2 sm:px-6 sm:py-2.5 md:px-8 md:py-3 rounded-lg font-semibold text-white text-sm sm:text-base md:text-lg border-2 transition-all hover:bg-white/10"
                  style={{ 

...
export default function NeYapmakIstiyoruzHero() {
  return (
    <section
    ...
    >
      <div
        className="container mx-auto w-full py-6 md:pt-8 lg:pt-12"
      ...
      >
        ...
        >
          Öğretmen dokunuşuyla yapılan yurtdışı eğitim hareketliliğinde coğrafi sınırları kaldırarak öğrencinin ufuk çizgisini muasır medeniyet çizgisinin üstüne taşımak.
        </motion.p>

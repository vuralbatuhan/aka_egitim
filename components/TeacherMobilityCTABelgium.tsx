...
export default function TeacherMobilityCTABelgium() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-center">
            ...
            >
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-2 md:mb-3">
                Belçika Öğretmen Eğitimine{" "}
                <span>
                  <span className="relative inline-block">
                    <span className="text-[#F39C12]">Başlamaya</span>
                    <span
              ...
              <p className="text-white text-sm sm:text-base md:text-lg lg:text-xl mb-1 md:mb-2 mt-3 md:mt-4">
                Uzman ekibimiz size Belçika&apos;da öğretmen eğitimi ve hareketlilik programını seçmenizde yardımcı olacak.
              </p>

...
const faqs = [
  {
    ...
    answer: "Evet, özellikle yüksek lisans seviyesinde birçok İngilizce program mevcuttur.",
  },
  {
    question: "Üniversite öğrencisi çalışabilir mi?",
    answer: "Evet, öğrenciler haftada 20 saat part-time çalışma hakkına sahiptir.",
  },
  {
    question: "Burs imkanları var mı?",
    answer: "Evet, hem üniversitelerin kendi bursları hem de İtalyan hükümeti bursları mevcuttur.",
  },
];

export default function UniversityItalyFAQ() {
  return (

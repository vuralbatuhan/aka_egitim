...
const features = [
  { text: "Dünya sıralamasında üst sıralarda yer alan üniversiteler" },
  { text: "3 yıllık lisans programları (İskoçya'da 4 yıl)" },
  { text: "Yüksek kaliteli öğretim ve araştırma" },
  { text: "Geniş burs imkanları" },
  { text: "Mezuniyet sonrası 2 yıl çalışma vizesi" },
  { text: "Uluslararası tanınırlık" },
];

export default function WhyEnglandUniversities() {
  return (
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
            ...
            <h2 id="neden" className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold" style={{ color: "#1a1a1a" }}>
              Neden İngiltere Üniversiteleri?
            </h2>
          </div>

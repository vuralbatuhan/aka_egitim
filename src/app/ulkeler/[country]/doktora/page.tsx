...
export async function generateMetadata({
  ...
  return {
    title: `${info.doctorate.title} | Aka Eğitim`,
    description: info.doctorate.description,
    keywords: [
      `${info.name.toLowerCase()} doktora`,
      `${info.name.toLowerCase()} phd`,
      "yurtdışı doktora",
      "aka eğitim",
    ],
    alternates: {
      canonical: `/ulkeler/${country.toLowerCase()}/doktora`,
    },
  };
}
...
export default async function DoctoratePage({ params }: PageProps) {
  const { country } = await params;
  const info = getCountryBySlug(country.toLowerCase());
  ...
  return (
    <main className="bg-white">
        ...
        <div className="absolute inset-0 overflow-hidden">
          {doctorate.heroImage && (
            <div
              ...
              style={{
                backgroundImage: `url(${doctorate.heroImage})`,
              }}
            ></div>
          )}
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 w-full">
          <div className="max-w-3xl">
            <nav className="text-white/80 mb-4 text-sm">
              ...
              <span className="text-white">Doktora</span>
            </nav>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-12">
            ...
            >
              Neden {info.name} Doktora?
            </h2>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {doctorate.whyChooseThis.map((reason, index) => (
              <div
                key={index}
      ...
      {doctorate.universities && doctorate.universities.length > 0 && (
        <section
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="text-center mb-12">
              <h2
                ...
                style={{ color: "var(--primary-dark)" }}
              >
                Doktora Programları Sunan Üniversiteler
              </h2>
              <p className="text-xl text-gray-600">
                Araştırma odaklı en iyi üniversiteler
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {doctorate.universities.map((uni, index) => (
                <div
                  key={index}
      ...
      <section id="programlar" className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Araştırma alanınıza uygun PhD programını seçin
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            {doctorate.programs.map((program, index) => (
              <div
                key={index}
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                {doctorate.requirements.map((req, index) => (
            ...
            <div>
              ...
              <div className="space-y-4">
                {doctorate.process.map((step, index) => (
                  <div key={index} className="flex items-start">
                    <div
                      className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center mr-3 mt-0.5"
                      style={{
                        background:
                          index === doctorate.process.length - 1
                            ? "var(--primary)"
                            : "var(--primary-light)",
                      }}
                    >
      ...
      {/* FAQs Section */}
      {doctorate.faqs && doctorate.faqs.length > 0 && (
        <section className="py-16 sm:py-20 bg-white">
      ...
      >
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          <h2
            ...
            style={{ color: "var(--primary-dark)" }}
          >
            {info.name} Doktorasına Başvurmaya Hazır Mısınız?
          </h2>
          <p className="text-xl text-gray-600 mb-8">
            Uzman ekibimiz araştırma önerinizi hazırlamanızda ve başvuru
            sürecinizde size rehberlik edecek!
          </p>

...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      title: `${info.title} | Aka Eğitim`,
      description: info.description,
      images: [{ url: 'https://akaegitim.com.tr/logo.jpg', width: 1200, height: 630, alt: `${info.name} eğitim danışmanlığı` }],
    },
    twitter: {
    ...
    <main className="bg-white">
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          ></div>
          <div className="absolute top-20 left-[20%] w-4 h-4 bg-white/40 rounded-full animate-float-reverse"></div>
          <div className="absolute top-40 right-[30%] w-6 h-6 bg-white/30 rounded-full animate-float"></div>
        </div>

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-32">
          <div className="text-center">
            {/* Badge */}
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/20 backdrop-blur-md text-white rounded-full mb-6 border border-white/30 shadow-lg">
              <div className="w-2 h-2 bg-white rounded-full animate-pulse"></div>
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span className="font-semibold tracking-wide">{info.name} Eğitim Fırsatları</span>
            </div>
            ...
            <p className="text-lg sm:text-xl lg:text-2xl max-w-4xl mx-auto text-white/90 leading-relaxed mb-10">
              {info.description}
            </p>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.2)' }}>
              Hizmetlerimiz
            </h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {info.services.map((service, index) => (
              ...
              >
                ...
                <svg className="w-5 h-5 text-white/80 flex-shrink-0 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section
        ...
        style={{ background: 'linear-gradient(180deg, #ffffff 0%, #f0fdfa 50%, #ffffff 100%)' }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div
      ...
      <section
        className="py-16 relative overflow-hidden"
        style={{ background: 'linear-gradient(180deg, #ffffff 0%, #f0fdfa 50%, #e0f7f5 100%)' }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            <div
          ...
          <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-8 overflow-hidden" style={{ border: '1px solid #d1fae5' }}>
            <div
              className="mb-8 p-6 rounded-2xl"
              style={{ background: 'linear-gradient(135deg, #e0f7f5 0%, #f0fdfa 100%)', border: '1px solid #a7f3d0' }}
            >
              <div className="flex items-start gap-4">
                <div
            ...
            <div className="rounded-2xl p-6" style={{ background: '#f0fdfa', border: '1px solid #d1fae5' }}>
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-white" style={{ textShadow: '0 2px 15px rgba(0,0,0,0.2)' }}>

...
export async function generateMetadata({
  ...
  if (!info?.mastersDegree) {
    return { title: "Sayfa Bulunamadı | Aka Eğitim" };
  }

  return {
    title: `${info.mastersDegree.title} | Aka Eğitim`,
    description: info.mastersDegree.description,
    keywords: [
      `${info.name.toLowerCase()} yüksek lisans`,
      `${info.name.toLowerCase()} master`,
      "yurtdışı yüksek lisans",
      "aka eğitim",
    ],
    alternates: {
      canonical: `/ulkeler/${country.toLowerCase()}/yuksek-lisans`,
    },
  };
}
...
export default async function MastersDegreePage({ params }: PageProps) {
  const { country } = await params;
  const info = getCountryBySlug(country.toLowerCase());
  ...
  return (
    <main className="bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 w-full">
          <div className="max-w-3xl">
            <nav className="text-white/80 mb-4 text-sm">
              ...
              <span className="text-white">Yüksek Lisans</span>
            </nav>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-12">
            ...
            >
              Neden {info.name} Yüksek Lisans?
            </h2>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mastersDegree.whyChooseThis.map((reason, index) => (
              <div
                key={index}
      ...
      {mastersDegree.universities && mastersDegree.universities.length > 0 && (
        <section
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Yüksek lisans programları sunan en iyi üniversiteler
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {mastersDegree.universities.map((uni, index) => (
                <div
                  key={index}
      ...
      <section id="programlar" className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              İhtiyacınıza uygun master programını seçin
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            {mastersDegree.programs.map((program, index) => (
              <div
                key={index}
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                {mastersDegree.requirements.map((req, index) => (
            ...
            <div>
              ...
              <div className="space-y-4">
                {mastersDegree.process.map((step, index) => (
                  <div key={index} className="flex items-start">
                    <div
                      className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center mr-3 mt-0.5"
                      style={{
                        background:
                          index === mastersDegree.process.length - 1
                            ? "var(--primary)"
                            : "var(--primary-light)",
                      }}
                    >
      ...
      {/* FAQs Section */}
      {mastersDegree.faqs && mastersDegree.faqs.length > 0 && (
        <section className="py-16 sm:py-20 bg-white">
          <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div className="space-y-6">
              {mastersDegree.faqs.map((faq, index) => (
                <div
                  key={index}
      ...
      >
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          <h2
            ...
            style={{ color: "var(--primary-dark)" }}
          >
            {info.name} Yüksek Lisansına Başvurmaya Hazır Mısınız?
          </h2>

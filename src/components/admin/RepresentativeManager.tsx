...
export default function RepresentativeManager() {
  ...
  const [editingRep, setEditingRep] = useState<RepresentativeWithCity | null>(
    null
  );
    ...
    try {
      ...
      if (uploadError) {
        ...
        if (
          ...
          alert(
            "Storage bucket bulunamadı veya dosya zaten mevcut. Lütfen Supabase Storage'da \"representatives\" bucket'ını oluşturun."
          );
          return null;
        }
  ...
  const handleAddRepresentative = async () => {
    ...
    try {
        ...
        try {
          ...
          if (uploadedUrl) {
            ...
            const continueWithoutAvatar = confirm(
              "Fotoğraf yüklenemedi. Avatar olmadan devam etmek ister misiniz?"
            );
          ...
          const continueWithoutAvatar = confirm(
            "Fotoğraf yüklenirken bir hata oluştu. Avatar olmadan devam etmek ister misiniz?"
          );
          if (!continueWithoutAvatar) {
            setLoading(false);
            return;
      ...
      if (newRep.languages?.trim()) {
        representativeData.languages = newRep.languages
          .split(",")
          .map((l) => l.trim())
          .filter(Boolean);
      }
  ...
  const handleEditRepresentative = async () => {
    ...
    try {
      ...
      const avatarRemoved =
        !editAvatarPreview && editingRep.avatar && !editAvatarFile;
        ...
        try {
          ...
          if (uploadedUrl) {
            ...
            const continueWithExisting = confirm(
              "Fotoğraf yüklenemedi. Mevcut fotoğraf ile devam etmek ister misiniz?"
            );
          ...
          console.error("Avatar upload error:", error);
          const continueWithExisting = confirm(
            "Fotoğraf yüklenirken bir hata oluştu. Mevcut fotoğraf ile devam etmek ister misiniz?"
          );
          if (!continueWithExisting) {
            setLoading(false);
            return;
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm sm:text-base text-gray-600">
            Şehir seçerek temsilcileri görüntüleyin ve yönetin
          </p>
        </div>
        <Button
          color="primary"
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-start md:items-center justify-between">
            <div className="flex-1 w-full md:w-auto">
              ...
              <p className="text-gray-600 text-xs sm:text-sm">
                Temsilcilerini yönetmek için önce bir ülke seçin
              </p>
            </div>
              ...
              {isMobile ? (
                    ...
                    <ModalContent>
                      <ModalHeader className="flex flex-col gap-1 p-6 border-b border-gray-200">
                        ...
                        <p className="text-sm text-gray-600">
                          Temsilcilerini yönetmek için bir ülke seçin
                        </p>
                      </ModalHeader>
                ...
                <Select
                  ...
                  classNames={{
                    ...
                    trigger:
                      "bg-white pl-3 focus:outline-none focus:ring-0 data-[focus=true]:ring-0",
                ...
                >
                  {COUNTRIES.map((country, index) => (
                    <SelectItem
                      ...
                      classNames={{
                        base: `rounded-md hover:bg-primary/10   ${
          ...
          <CardBody className="p-4 sm:p-6">
            <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-start md:items-center justify-between">
              <div className="flex-1 w-full md:w-auto">
                ...
                <p className="text-gray-600 text-xs sm:text-sm">
                  Türkiye&apos;de temsilcilerini görmek için bir şehir seçin
                </p>
              </div>
              <div className="w-full md:w-auto md:max-w-xs">
                    ...
                    >
                      <ModalContent>
                        <ModalHeader className="flex flex-col gap-1 p-6 border-b border-gray-200">
                          ...
                          <p className="text-sm text-gray-600">
                            Türkiye&apos;de temsilcilerini görmek için bir şehir
                            seçin
                          </p>
                        </ModalHeader>
                        <ModalBody className="p-0">
                ...
                <div className="space-y-2 text-sm">
                  {selectedCityData.officeAddress ? (
                    <p className="text-gray-700">
                      <strong>Adres:</strong> {selectedCityData.officeAddress}
                    </p>
                  ) : (
                  ...
                  {selectedCityData.officePhone ? (
                    <p className="text-gray-700">
                      <strong>Telefon:</strong> {selectedCityData.officePhone}
                    </p>
                  ) : (
                    <p className="text-gray-500 italic">
                  ...
                  {!selectedCityData.officeAddress &&
                    !selectedCityData.officePhone && (
                      <p className="text-gray-500 italic text-center py-2">
                        Ofis bilgileri henüz eklenmemiş. Düzenle butonuna
          ...
          <CardBody className="p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600">
                  Bu ülke için temsilcileri yönetin
                </p>
              </div>
              <Button
                color="primary"
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">
                Bu ülke için henüz temsilci eklenmemiş
              </p>
              <Button
                color="primary"
                variant="flat"
        ...
        <Card>
          <CardBody className="p-12 text-center">
            ...
            <p className="text-gray-500">
              Temsilcileri görüntülemek için yukarıdan bir ülke seçin
            </p>
          </CardBody>
        </Card>
      )}
      ...
      {selectedCountry === "tr" && !selectedCityId && !loading && (
        <Card>
          <CardBody className="p-12 text-center">
            ...
            <p className="text-gray-500">
              Türkiye&apos;de temsilcileri görüntülemek için yukarıdan bir şehir
              seçin
            </p>
          </CardBody>
        </Card>
              ...
              <ModalBody className="p-6 sm:p-8">
                <div className="space-y-6">
                  ...
                  <Input
                    ...
                    onValueChange={(value) =>
                      setNewCity({ ...newCity, office_address: value })
                    }
                    variant="bordered"
                    classNames={{
                      input: "bg-white focus:outline-none focus:ring-0",
                  ...
                  <Input
                    ...
                    onValueChange={(value) =>
                      setNewCity({ ...newCity, office_phone: value })
                    }
                    variant="bordered"
                    classNames={{
                      input: "bg-white focus:outline-none focus:ring-0",
              ...
              <ModalHeader className="flex flex-col gap-2 bg-white border-b border-gray-200 p-6 sm:p-8">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  {selectedCity?.city_name
                    ? `${selectedCity.city_name} için`
                    : "Yeni temsilci bilgilerini girin"}
                </p>
              </ModalHeader>
              <ModalBody className="p-6 sm:p-8">
                <div className="space-y-6">
                    ...
                    <div className="relative">
                      {avatarPreview ? (
                        ...
                        <div className="w-32 h-32 rounded-full bg-gradient-to-br from-primary to-primary-600 flex items-center justify-center text-white text-4xl font-bold border-4 border-primary shadow-lg">
                          {newRep.name
                            ? newRep.name.charAt(0).toUpperCase()
                            : "?"}
                        </div>
                      )}
                    </div>
                  ...
                  <Input
                    ...
                    onValueChange={(value) =>
                      setNewRep({ ...newRep, languages: value })
                    }
                    variant="bordered"
                    classNames={{
                      input: "bg-white focus:outline-none focus:ring-0",
                  ...
                  <Input
                    ...
                    onValueChange={(value) =>
                      setNewRep({ ...newRep, working_hours: value })
                    }
                    variant="bordered"
                    classNames={{
                      input: "bg-white focus:outline-none focus:ring-0",
          ...
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-2 bg-white border-b border-gray-200 p-4 sm:p-5">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Temsilci bilgilerini güncelleyin
                </p>
              </ModalHeader>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <Input
                        ...
                        onValueChange={(value) =>
                          setEditingRep({ ...editingRep, name: value })
                        }
                        variant="bordered"
                        classNames={{
                          input: "bg-white focus:outline-none focus:ring-0",
                      ...
                      <Input
                        ...
                        onValueChange={(value) =>
                          setEditingRep({ ...editingRep, title: value })
                        }
                        variant="bordered"
                        classNames={{
                          input: "bg-white focus:outline-none focus:ring-0",
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <Input
                        ...
                        onValueChange={(value) =>
                          setEditingRep({ ...editingRep, phone: value })
                        }
                        variant="bordered"
                        classNames={{
                          input: "bg-white focus:outline-none focus:ring-0",
                      ...
                      <Input
                        ...
                        onValueChange={(value) =>
                          setEditingRep({ ...editingRep, email: value })
                        }
                        variant="bordered"
                        classNames={{
                          input: "bg-white focus:outline-none focus:ring-0",
                    ...
                    <Input
                      ...
                      onValueChange={(value) =>
                        setEditingRep({ ...editingRep, working_hours: value })
                      }
                      variant="bordered"
                      classNames={{
                        input: "bg-white focus:outline-none focus:ring-0",

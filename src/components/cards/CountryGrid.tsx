...
const COUNTRIES: Country[] = [
  {
    name: "İtalya",
    slug: "italya",
    image: "https://images.unsplash.com/photo-1528297506728-9533d2ac3fa4?w=500&q=80",
  ...
  },
  {
    ...
    description: "Uygun maliyetli İngilizce ve Rusça dil programları ile Türk öğrenciler için ideal.",
  ...
  },
  {
    name: "Hollanda",
    slug: "hollanda",
    image: "https://images.unsplash.com/photo-1523805009345-7448845a9e53?w=500&q=80",
              ...
              <CardBody className="p-0">
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <div className="flex items-center justify-between mb-6 bg-primary/5 rounded-lg p-4">
                    <span className="text-foreground/70 font-medium">Haftalık Fiyat</span>

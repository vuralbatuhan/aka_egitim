...
export default function ContactForm() {
  ...
  const programs = [
    ...
    { key: "yuksek-lisans", label: "Yüksek Lisans" },
    { key: "yaz-okulu", label: "Yaz Okulu" },
  ];
  ...
  const countries = [
    ...
    { key: "irlanda", label: "İrlanda" },
    { key: "kanada", label: "Kanada" },
    { key: "hollanda", label: "Hollanda" },
  ...
  return (
    <section id="contact-form" className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-slate-50 via-white to-blue-50/50 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-14">
          <div className="inline-flex items-center justify-center p-2 bg-primary/10 rounded-full mb-4">
            <span className="text-sm font-semibold text-primary px-4 py-1">Ücretsiz Danışmanlık</span>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="space-y-7">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Size ulaşmamız için gerekli bilgiler</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <Input
                    ...
                    classNames={{
                      ...
                      inputWrapper: "border-2 border-gray-200 hover:border-primary/60 data-[hover=true]:border-primary/60 group-data-[focus=true]:border-primary focus-within:!outline-none focus-within:!ring-0 data-[focus=true]:!outline-none data-[focus=true]:!ring-0 shadow-sm hover:shadow-md transition-all duration-200 !outline-none !ring-0",
              ...
              <div className="space-y-7 pt-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900">Eğitim Tercihleri</h3>
                    <p className="text-sm text-gray-500">Hangi program ve ülkeyle ilgileniyorsunuz?</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="w-full">
                    <Dropdown onOpenChange={setIsProgramOpen}>
                      <DropdownTrigger>
                        <Button
                          ...
                          endContent={
                            <ChevronDownIcon className={`w-5 h-5 text-gray-400 transition-transform duration-200 ${isProgramOpen ? 'rotate-180' : ''}`} />
                          }
                          startContent={
                            <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                        ...
                        >
                          <span className="text-gray-900 font-normal flex-1 text-left">
                            {formData.program
                              ? programs.find(p => p.key === formData.program)?.label
                      ...
                      <DropdownMenu
                        ...
                        onSelectionChange={(keys) => {
                          ...
                          setFormData({...formData, program: selectedKey || ''});
                          setValidationErrors({...validationErrors, program: ''});
                        }}
                        itemClasses={{
                    ...
                    {validationErrors.program && (
                      <p className="text-red-500 text-sm mt-2">{validationErrors.program}</p>
                    )}
                  </div>

                  {/* Country Dropdown */}
                  <div className="w-full">
                    <Dropdown onOpenChange={setIsCountryOpen}>
                      <DropdownTrigger>
                        <Button
                          variant="bordered"
                          className={`w-full h-14 justify-between bg-white border-2 ${
                          ...
                          endContent={
                            <ChevronDownIcon className={`w-5 h-5 text-gray-400 transition-transform duration-200 ${isCountryOpen ? 'rotate-180' : ''}`} />
                          }
                          startContent={
                            <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4 pt-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900">Mesajınız</h3>
                    <p className="text-sm text-gray-500">Detayları bizimle paylaşın (İsteğe bağlı)</p>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 border-2 border-green-200 rounded-2xl p-6 sm:p-8 pt-8 shadow-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 space-y-4">
                    <div>
                      <h4 className="font-bold text-gray-900 text-base sm:text-lg mb-1">Gizlilik ve Güvenlik</h4>
                      <p className="text-sm text-gray-600">Verileriniz güvende, %100 güvenli işlem</p>
                    </div>
                    <div className="flex flex-col gap-2">
                      <div className="flex items-start gap-3 p-4 bg-white/80 rounded-xl border border-gray-200">
                        <Checkbox
                          ...
                          className="mt-0.5"
                          classNames={{
                            base: validationErrors.acceptTerms ? 'border-red-500' : '',
                          }}
                        />
                        <label className="text-sm sm:text-base text-gray-700 leading-relaxed flex-1 cursor-pointer" onClick={() => setFormData({...formData, acceptTerms: !formData.acceptTerms})}>
                          <a href="/kvkk" target="_blank" className="text-primary font-bold hover:underline hover:text-primary/80 transition-colors" onClick={(e) => e.stopPropagation()}>KVKK Bilgilendirmesi</a> ve <a href="/acik-riza" target="_blank" className="text-primary font-bold hover:underline hover:text-primary/80 transition-colors" onClick={(e) => e.stopPropagation()}>Açık Rıza Beyan Metni</a>&apos;ni okudum, onaylıyorum.
                        </label>
                      </div>
              ...
              <div className="space-y-6 pt-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                  <div className="group bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-5 text-center hover:shadow-lg hover:scale-105 transition-all duration-300">
                    ...
                    <p className="text-sm font-bold text-green-900 mb-1">100% Ücretsiz</p>
                    <p className="text-xs text-green-700">Danışmanlık Hizmeti</p>
                  </div>
                  ...
                  <div className="group bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 rounded-xl p-5 text-center hover:shadow-lg hover:scale-105 transition-all duration-300">
                    ...
                    <p className="text-sm font-bold text-blue-900 mb-1">24 Saat İçinde</p>
                  ...
                  <div className="group bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 rounded-xl p-5 text-center hover:shadow-lg hover:scale-105 transition-all duration-300">
                    ...
                    <p className="text-sm font-bold text-purple-900 mb-1">Uzman Kadro</p>
                    <p className="text-xs text-purple-700">Profesyonel Destek</p>
                  </div>
                </div>
              </div>
            </form>

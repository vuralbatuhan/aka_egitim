      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Kurumsal değerlerimizi ve öğrenci odaklı yaklaşımımızı keşfederek
            size en uygun yurtdışı eğitim çözümünü birlikte belirleyelim.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {benefits.map((benefit, index) => (
            <Link key={index} href={benefit.link} className="block">
              <Card className="hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-turquoise-500   overflow-hidden group h-full">

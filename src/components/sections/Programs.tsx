  ...
  const programs = [
    {
      ...
      title: "Dil Okulları",
      description:
        "Yurtdışında ana dilini konuştuğu ülkede dil öğrenmenin en etkili yolu. İngiltere, Malta, İrlanda ve daha fazlası...",
      features: [
    ...
    },
    {
      ...
      title: "Üniversite",
      description:
        "Dünya çapında tanınan üniversitelerde lisans eğitimi. YÖK tarafından tanınan kurumlarla çalışıyoruz.",
      features: [
        "Lisans Programları",
        "Foundation Yıl",
        "Transfer İmkanları",
    ...
    },
    {
      ...
      title: "Yüksek Lisans",
      description:
        "Kariyerinizi bir üst seviyeye taşıyacak master ve MBA programları.",
      features: [
        "Master Programları",
        "MBA Programları",
        "Doktora Programları",
    ...
    },
    {
      ...
      title: "Yaz Okulları",
      description:
        "Yaz aylarında kısa süreli dil eğitimi ve kültür deneyimi programları.",
      features: [
        "Yaz Dil Kursları",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto px-4">
            Size uygun eğitim programını seçin ve yurtdışı eğitim hayalinizi
            gerçekleştirin
          </p>
        </div>

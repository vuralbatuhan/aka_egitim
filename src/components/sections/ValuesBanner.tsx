...
export default function ValuesBanner() {
  ...
  const values = [
    ...
    { text: 'Adalet', color: 'from-red-700 to-red-800' }
  ]
  ...
  return (
    <section className="relative py-16 sm:py-20 lg:py-24 overflow-hidden bg-gradient-to-br from-red-50 via-white to-red-50">
      ...
      <div className="absolute bottom-0 right-0 w-40 h-40 bg-red-300 rounded-full blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }} />
          ...
          {values.map((value, index) => (
            ...
            >
              <div className={`
                ...
                ${index === 1 ? 'text-transparent bg-clip-text' : 'text-transparent bg-clip-text'}
                drop-shadow-2xl
                animate-pulse-slow
                tracking-tight
              `}
          ...
          {values.map((value, index) => (
            <div
              ...
              className={`
                ...
                border-2 ${index === activeIndex ? 'border-red-600 shadow-xl' : 'border-gray-200 hover:border-red-300'}
            ...
            >
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
                  {index === 0 && 'Hedeflerinize ulaşma yolunda kararlı adımlar'}
                  {index === 1 && 'Eğitim yolculuğunuzda yanınızda kalma taahhüdü'}

...
export const countries: Record<string, CountryInfo> = {
  'italya': {
    ...
    description: 'İtalya, tarihi zenginliği, sanat ve kültür mirası ile dünyanın en önemli eğitim merkezlerinden biridir. İtalyanca dil eğitimi, moda ve tasarım okulları ile öne çıkan İtalya, öğrencilere benzersiz bir akademik ve kültürel deneyim sunar.',
    whyChooseUs: [
    ...
    languagePrograms: [
      {
        ...
        duration: '2-52 hafta',
        description: 'Haftada 20-30 saat İtalyanca eğitimi ile dil seviyenizi hızla geliştirin'
      },
      {
        name: 'İtalyanca + Kültür Programı',
        duration: '4-24 hafta',
        description: 'İtalyanca öğrenirken İtalyan mutfağı, sanat tarihi ve kültürü keşfedin'
      },
      {
        name: 'Üniversite Hazırlık',
        duration: '6-12 ay',
        description: 'İtalyan üniversitelerine kabul için gerekli B2/C1 seviyesi İtalyanca eğitimi'
      },
      {
        name: 'İş İtalyancası',
        duration: '4-12 hafta',
        description: 'Profesyonel yaşamda kullanabileceğiniz İş İtalyancası eğitimi'
      },
    ],
    universities: [
      {
        ...
        city: 'Bologna',
        description: 'Dünyanın en eski üniversitesi, mühendislik ve sanat programları'
      },
      {
        name: 'Politecnico di Milano',
        city: 'Milano',
        description: 'Avrupa\'nın en iyi teknik üniversitelerinden, moda ve tasarım'
      },
      {
        name: 'Sapienza Università di Roma',
        city: 'Roma',
        description: 'İtalya\'nın en büyük üniversitesi, geniş program yelpazesi'
      },
    ],
    statistics: [
  ...
  'ingiltere': {
    ...
    description: 'İngiltere, dünyanın en prestijli üniversitelerine ev sahipliği yapar ve İngilizce öğrenmek için en ideal destinasyonlardan biridir. Oxford, Cambridge ve London gibi tarihi şehirlerde kaliteli eğitim imkanları sunar.',
    whyChooseUs: [
    ...
    languagePrograms: [
      {
        ...
        duration: '2-48 hafta',
        description: 'Haftada 15-30 saat İngilizce eğitimi ile konuşma, okuma, yazma becerilerinizi geliştirin'
      },
      {
        name: 'IELTS Hazırlık',
        duration: '4-12 hafta',
      ...
      },
      {
        ...
        description: 'İngiliz üniversitelerine başvuru için gerekli akademik İngilizce eğitimi'
      },
      {
        name: 'İş İngilizcesi',
        duration: '2-8 hafta',
        description: 'Profesyonel iş dünyasında kullanabileceğiniz İngilizce programı'
      },
      {
    ...
    universities: [
      {
        ...
        city: 'Oxford',
        description: 'Dünyanın en prestijli üniversitesi, tüm alanlarda mükemmellik'
      },
      {
      ...
      },
      {
        ...
        city: 'London',
        description: 'Mühendislik, tıp ve bilim alanlarında dünya çapında tanınır'
      },
      {
        name: 'London School of Economics (LSE)',
        city: 'London',
        description: 'Sosyal bilimler, ekonomi ve siyaset alanında dünyanın en iyisi'
      },
    ],
    statistics: [
  ...
  'belcika': {
    ...
    description: 'Belçika, Avrupa\'nın kalbinde yer alan çok kültürlü bir ülkedir. Yüksek kaliteli eğitim sistemi, üç resmi dili ve uluslararası kuruluşlara ev sahipliği yapmasıyla öğrenciler için ideal bir destinasyondur.',
    whyChooseUs: [
  ...
  'almanya': {
    ...
    description: 'Almanya, dünya çapında tanınan üniversiteleri, güçlü ekonomisi ve ücretsiz eğitim fırsatlarıyla uluslararası öğrenciler için en popüler destinasyonlardan biridir. Mühendislik, teknoloji ve araştırma alanlarında öncü konumdadır.',
    whyChooseUs: [
  ...
  'kazakistan': {
    ...
    description: 'Kazakistan, Orta Asya\'nın en gelişmiş eğitim sistemlerinden birine sahiptir. Uygun maliyetli eğitim, Türk kültürüne yakınlık ve modern üniversiteler ile uluslararası öğrenciler için cazip bir destinasyondur.',
    whyChooseUs: [
  ...
  'hollanda': {
    ...
    description: 'Hollanda, İngilizce eğitim programları, yenilikçi öğretim yöntemleri ve uluslararası akademik ortamıyla bilinir. Yüksek yaşam kalitesi ve çok kültürlü yapısı ile öğrencilere benzersiz bir deneyim sunar.',
    whyChooseUs: [
  ...
  'finlandiya': {
    ...
    description: 'Finlandiya, dünyanın en başarılı eğitim sistemine sahip ülkelerden biridir. Kaliteli ücretsiz eğitim, yüksek yaşam standartları ve doğal güzellikleri ile öğrenciler için ideal bir destinasyondur.',
    whyChooseUs: [
    ...
    universities: [
      {
        ...
        city: 'Helsinki',
        description: 'Finlandiya\'nın en prestijli üniversitesi, araştırma odaklı'
      },
      {
